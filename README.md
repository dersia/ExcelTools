...
* [Open Excel and sideload the manifest](https://docs.microsoft.com/en-us/office/dev/add-ins/testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins)

### Using Excel Online
* Start the dev-server
* [Open Excel upload the manifest file](https://docs.microsoft.com/en-us/office/dev/add-ins/testing/sideload-office-add-ins-for-testing)
